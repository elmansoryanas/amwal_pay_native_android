...
class PayWithQrUseCase extends IUseCase<QRResponse, WalletPaymentRequest> {
  final SaleByWalletRepository _saleByWalletRepository;
  const PayWithQrUseCase(this._saleByWalletRepository);

  @override
  Future<NetworkState<QRResponse>> invoke(WalletPaymentRequest param) async {
    return await _saleByWalletRepository.payWithQR(param.payWithQrCode());
  }
}
